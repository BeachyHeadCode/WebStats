...
<div class="row">
	<div class="twelve columns">
		<nav class="top-bar">
			<ul id="main-menu">
<li class="name"><a class="ajax-link" href="index.php" <?php echo (hover);?> ><span><?php echo translate(var6); ?></span></a></li>
...
<li><?php if($mcmmo_control === true && pluginconfigstatusmcmmo === true){echo '<a class="ajax-link" href="?mode=mcmmo" title="'.translate(var78).'" '.hover.'><span>'.translate(var78).'</span></a>';} ?></li>
<li><?php if($InventorySQL_control === true){echo '<a class="ajax-link" href="?mode=inventorysql" title="'.translate(var79).'" '.hover.'><span>'.translate(var79).'</span></a>';} ?></li>
				</ul>
