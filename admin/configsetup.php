...
//IF YOU DONT KNOW YOU CAN VIEW IP LOG FROM PHP IN THE FOLDER IT WAS INSTALLED.
	echo '<h1><div align="center">Your config file is already made!<br /><a href="../">Return to the home page.</a></div></h1>';
} else {
			...
			<tbody>           
				<tr>
					...
					<td>
						...
						<?php $statstype = array('Chose Plugin', 'BeardStat', 'HawkEye', 'Logblock', 'Stats & Achievements', 'Stats', 'Stats 2.0', 'Stats by lolmewnstats', 'Stats3 by lolmewnstats', 'Statistician v2.0');
...
?>
	...
	<img id="imageplaceholder" src="../images/background/bg_<?php if(!isset($_SESSION['page']['default_background'])){ echo 'blackfade';}else{ echo $_SESSION['page']['default_background'];} ?>.png" alt="Background" style="height: 200px; max-width: 100%;" width="300px" />
	...
	<label for="page">Main Page Link: <input name="page[homepage_link]" type="text" id="page[homepage_link]" title="Homepage Link" value="<?php if(!isset($_SESSION['page']['homepage_link'])){ echo 'https://nicholas-smith.tk';}else{ echo $_SESSION['page']['homepage_link'];} ?>" maxlength="64"/></label>
...
if((isset($_SESSION['pluginconfigstats'])) && ($_SESSION['pluginconfigstats'] != 'Chose Plugin')) {
	...
	} elseif($_SESSION['pluginconfigstats'] == "Stats3 by lolmewnstats") {
		if($_SESSION['page']['timechange_on/off'] == true)
			$stats_time="define('WS_CONFIG_PLAYTIME', ".$_SESSION['page']['timechange_on/off'].");\n";
		$stats="define('WS_CONFIG_STATS_PLUGIN', 'stats3-lolmewn');\ndefine('WS_CONFIG_STATS', '".$_SESSION['page']['stats_table_name']."');\n$stats_time";
		$pluginconfigstatusstats="define('pluginconfigstatusstatslolmewnstats3', true);\n";
