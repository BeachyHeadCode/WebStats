...
function recipeparser_crafting($id){
	...
	echo '<table cellpadding="0" cellspacing="0" class="grid-Crafting_Table" style="width:217px; height:125px; position:relative; float:left; margin:4px;"><tbody>';
		echo '<tr>';
			...
			echo '<td rowspan="2" class="arrow"><img alt="Grid layout Arrow (small).png" src="include/recipe/images/Grid_layout_Arrow_%28small%29.png"width="32" height="27" /></td>';
...
function recipeparser_brewing($id){
	...
	echo '<table cellpadding="0" cellspacing="0" class="grid-Brewing_Stand" style="width:217px; height:125px; position:relative; float:left; margin:4px;"><tbody>';
		echo '<tr>';
			echo '<td class="bubbles"><img alt="Grid layout Brewing Bubbles.gif" src="include/recipe/images/brewing_bubbles.gif" width="24px" height="57px" border="0" /></td>';
			...
			echo '<td class="arrow"><img alt="Grid layout Brewing Arrow.png" src="include/recipe/images/Grid_layout_Brewing_Arrow.png"width="18" height="57"></td>';
		echo '</tr><tr>';
			if($parser_step_2_line_2[0] != 'null'){echo '<td class="output1"><span class="grid2"><span class="border"><span><span class="image"><a href="index.php?mode=material-stats&material='.$parser_step_2_line_2[0].'" style="cursor:url(images/cursors/hover.cur),auto;" title="'.translate($translate_line2_item1).'"><img src="images/icons/'.$parser_step_2_line_2[0].'.png" width="32px" height="32px" border="0" /></a></span></span></span></span></td>';} else {echo '<td class="output1"><span class="grid2"><span class="border"><span><span class="default-image"><img src="include/recipe/images/Grid_layout_Brewing_Empty.png" width="32" height="32" /></span></span></span></span></td>';}
			if($parser_step_2_line_2[1] != 'null'){echo '<td class="output2"><span class="grid2"><span class="border"><span><span class="image"><a href="index.php?mode=material-stats&material='.$parser_step_2_line_2[1].'" style="cursor:url(images/cursors/hover.cur),auto;" title="'.translate($translate_line2_item2).'"><img src="images/icons/'.$parser_step_2_line_2[1].'.png" width="32px" height="32px" border="0" /></a></span></span></span></span></td>';} else {echo '<td class="output2"><span class="grid2"><span class="border"><span><span class="default-image"><img src="include/recipe/images/Grid_layout_Brewing_Empty.png" width="32" height="32" /></span></span></span></span></td>';}
			if($parser_step_2_line_2[2] != 'null'){echo '<td class="output3"><span class="grid2"><span class="border"><span><span class="image"><a href="index.php?mode=material-stats&material='.$parser_step_2_line_2[2].'" style="cursor:url(images/cursors/hover.cur),auto;" title="'.translate($translate_line2_item3).'"><img src="images/icons/'.$parser_step_2_line_2[2].'.png" width="32px" height="32px" border="0" /></a></span></span></span></span></td>';} else {echo '<td class="output3"><span class="grid2"><span class="border"><span><span class="default-image"><img src="include/recipe/images/Grid_layout_Brewing_Empty.png" width="32" height="32" /></span></span></span></span></td>';}
		echo '</tr><tr>';
			echo '<td class="paths" colspan="3"><img alt="Grid layout Brewing Paths.png" src="include/recipe/images/Grid_layout_Brewing_Paths.png" width="60" height="40" /></td>';
...
function recipeparser_smelting($id){
	...
	echo '<tr><td><span class="grid2"><span class="border"><span class="image"><a href="index.php?mode=material-stats&material='.$parser_step_2_line_2[0].'" title="'.translate($translate_input_top).'" style="cursor:url(images/cursors/hover.cur),auto;" ><img alt="'.translate($parser_step_2_line_2[0]).'" src="images/icons/'.$parser_step_2_line_2[0].'.png" width="32px" height="32px" border="0" /></a></span></span></span></td>';
 	echo '<td rowspan="3" class="arrow"><img alt="Grid layout Furnace Progress.png" src="include/recipe/images/Grid_layout_Furnace_Progress.png" width="44" height="36"></td>';	
	...
	echo '<tr><td><span class="image"><img alt="Furnace Grid Fire.png" src="include/recipe/images/furnace_grid_fire.png" width="36" height="36"></span></td></tr>';
