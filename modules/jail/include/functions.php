...
function get_jail_user_stats_order($sort, $start, $end)
{
	...
	$result = "SELECT * FROM ".WS_CONFIG_JAIL."prisoners WHERE ".WS_CONFIG_JAIL."prisoners.PlayerName != '' ".$sortkey." LIMIT ".$start.",".$end."";
...
{
	$pos++;
	$query = "SELECT * FROM ".WS_CONFIG_JAIL."prisoners WHERE ".WS_CONFIG_JAIL."prisoners.PlayerName = '".$player."'";
