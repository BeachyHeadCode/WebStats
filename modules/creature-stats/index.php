	...
	<div class="content_headline" style="width:748px;">
		<b>
			<img src="images/icons/<?php echo $_GET['creature']; ?>.png" width="15px" height="15px">
				<u><a href="http://www.minecraftwiki.net/wiki/<?php echo translate($_GET['creature']);?>" <?php echo (hover);?>><?php echo translate($_GET['creature']); ?></a></u>
			<img src="images/icons/<?php echo $_GET['creature']; ?>.png" width="15px" height="15px">
		</b>
	</div>
	<br/><br/>
	<div class="content_headline" style="width:748px;">
		<a href="index.php?mode=creature-stats&creature=<?php echo $_GET['creature']; ?>"<?php echo (hover);?>><?php echo translate('var1'); ?></a> - <a href="index.php?mode=creature-stats&search=true&creature=<?php echo $_GET['creature']; ?>"<?php echo (hover);?>><?php echo translate('var2'); ?></a>
	</div>
